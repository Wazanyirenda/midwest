...
select seed_product(
  'GLP-3', 'Triple Receptor Agonist Peptide',
  'GLP-3 is an investigational GIP/GLP-1/glucagon triple receptor agonist peptide. For research use only — not for human consumption.',
  'glp-3', 'peptide',
  '[{"title": "10mg Vial", "sku": "GLP3-10MG", "price_cents": 4000},
    {"title": "20mg Vial", "sku": "GLP3-20MG", "price_cents": 8000}]'
);
...
update products set tags = tags || '{new}'
  where handle in ('glp-3', 'kpv', 'mots-c');
