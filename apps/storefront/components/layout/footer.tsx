      ...
      <div className="border-t border-white/5">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6">
          <p className="text-xs text-sand-600 leading-relaxed max-w-3xl">
            ...
            research and scientific investigation by qualified researchers. Not for human or
            animal consumption, medical treatment, or any therapeutic application. These
