...
export function SignUpForm() {
  ...
  if (sent) {
    return (
      <div className="rounded-xl border border-sand-200 bg-white p-8 text-center shadow-md">
        ...
        <h2 className="mb-2 text-lg font-semibold text-sand-900">Confirm your email</h2>
        <p className="text-sm text-sand-600">{sent}</p>
  ...
  return (
    ...
    >
      ...
      <label className="flex items-start gap-3 text-sm text-sand-600">
        <input
