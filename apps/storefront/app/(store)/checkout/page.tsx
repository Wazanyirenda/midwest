...
export default async function CheckoutPage() {
  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
      <h1 className="text-3xl font-bold text-sand-900 mb-10">Checkout</h1>
      ...
      <div className="grid grid-cols-1 gap-10 lg:grid-cols-5">
        ...
        <aside className="lg:col-span-2">
          <div className="sticky top-24 rounded-xl border border-sand-200 bg-sand-50 p-6">
            <h2 className="font-semibold text-sand-900 mb-4">Order Summary</h2>
            ...
            <div className="border-t border-sand-200 pt-4 space-y-1 text-sm">
            ...
            <div className="border-t border-sand-200 mt-3 pt-3 flex justify-between font-semibold text-sand-900">
              <span>Total</span>
