...
export default function ShippingPage() {
  return (
    <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      <h1 className="text-3xl font-bold text-sand-900">Shipping Policy</h1>

      <div className="mt-8 space-y-8">
        {/* Processing */}
        <section className="rounded-xl border border-sand-200 p-6">
          <h2 className="text-xl font-semibold text-sand-900 mb-4">Processing Time</h2>
        ...
        {/* Domestic */}
        <section className="rounded-xl border border-sand-200 p-6">
          <h2 className="text-xl font-semibold text-sand-900 mb-4">Domestic Shipping (USA)</h2>
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-sand-200">
                  <th className="pb-2 text-left font-semibold text-sand-700">Method</th>
                  <th className="pb-2 text-left font-semibold text-sand-700">Carrier</th>
                  <th className="pb-2 text-left font-semibold text-sand-700">Estimated Delivery</th>
                  <th className="pb-2 text-right font-semibold text-sand-700">Cost</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-sand-100 text-sand-600">
                <tr>
        ...
        {/* Packaging */}
        <section className="rounded-xl border border-sand-200 p-6">
          <h2 className="text-xl font-semibold text-sand-900 mb-4">Discreet Packaging</h2>
        ...
        {/* Temperature */}
        <section className="rounded-xl border border-sand-200 p-6">
          <h2 className="text-xl font-semibold text-sand-900 mb-4">Temperature Considerations</h2>
          <p className="text-sand-600">
        ...
        {/* International */}
        <section className="rounded-xl border border-sand-200 p-6">
          <h2 className="text-xl font-semibold text-sand-900 mb-4">International Shipping</h2>
          <p className="text-sand-600">
        ...
        {/* Issues */}
        <section className="rounded-xl border border-sand-200 p-6">
          <h2 className="text-xl font-semibold text-sand-900 mb-4">Issues with Your Order</h2>
          <div className="space-y-3 text-sm text-sand-600">
            <p>
              <strong className="text-sand-700">Lost package:</strong> If tracking shows delivered but you
              haven't received it, wait 24 hours and then contact us. We'll work with the carrier to
              locate the package.
            </p>
            <p>
              <strong className="text-sand-700">Damaged package:</strong> Take photos immediately and
              contact us within 7 days of delivery. We will file a claim with the carrier and
              arrange a replacement.
            </p>
            <p>
              <strong className="text-sand-700">Wrong item:</strong> Contact us within 7 days of
